function [HammingLoss,RankingLoss,OneError,Coverage,Average_Precision,MaF1,MiF1,Outputs,Pre_Labels]=MLKNN_test(train_data,train_target,test_data,test_target,Num,Prior,PriorN,Cond,CondN)
...
%Evaluation
    ...
    MaF1=Macro_F1(Pre_Labels,test_target);
    MiF1=Micro_F1(Pre_Labels,test_target);
end
